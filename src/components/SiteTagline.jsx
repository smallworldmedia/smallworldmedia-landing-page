/**
 * SiteTagline — the persistent lower-left studio tagline (Figma Frame 19,
 * 08-27 Nathan).
 *
 * A fixed black pill — "VISUAL WORLDS for the music industry." — pinned to
 * the viewport's lower-left on every route. It REPLACES the footer's left
 ...
 *   · The pill wipes in left→right (clip-path, left edge anchored), the
 *     words fade up into position one by one starting just after the wipe.
 *
