---
description: Bootstrap a new session with full project context — reads the saved session state, verifies live Sanity data, checks git status, and presents a ready-to-go briefing. Use at the start of any new conversation to eliminate ramp-up time.
---
