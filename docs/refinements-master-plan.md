...
| A2b | Scroll tension **dial-in** | CREATIVE | ☐ | Nathan session: soften trigger values + fill `LENIS_TUNING`. ⚠️ Lenis feeds Grid Socket parallax + orbit scroll-kick — regression pass on document-scroll routes required. |
